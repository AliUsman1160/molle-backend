...
Route::get('/', [logincontroller::class, 'index'])->name('auth-login-basic');
Route::post('/login', [logincontroller::class, 'login'])->name('login');


Route::middleware('superadmin')->group(function () {
    Route::get('/laravel/user-management', [UserManagement::class, 'UserManagement'])->name('dashboard');
    Route::resource('/user-list', UserManagement::class);
    Route::post('user-list/{id}/update-status', [UserManagement::class, 'updateStatus']);

    Route::get('event-type', [EventtypeController::class, 'eventtype'])->name('event-type');
    Route::resource('/eventtype-list', EventtypeController::class);

    Route::get('event', [EventController::class, 'event'])->name('event');
    Route::resource('/event-list', EventController::class);

    Route::get('/document/{id}', [DocumentController::class, 'show'])->name('document.show');
    Route::post('/document/update-status/{id}', [DocumentController::class, 'updateStatus']);
